...
Square Square::operator+(const Square& rhs) {
    return Square(GetColor(), sideLength+rhs.sideLength);
}
 ...
 */
Square Square::operator*(const Square& rhs) {
    return Square(rhs.GetColor(), sideLength*rhs.sideLength);
}
 ...
 * radii are equal within the margin the margin of EPSILON
 */
bool Square::operator==(const Square& rhs) {
    return GetColor() == rhs.GetColor() &&
           sideLength == rhs.sideLength;
}